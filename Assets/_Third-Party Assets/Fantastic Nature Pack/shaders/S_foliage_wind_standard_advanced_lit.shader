	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 appendResult51 = (float4(( ( ( simplePerlin2D38 - 0.5 ) * _WindStrength ) + break49.x ) , break49.y , break49.z , 0.0));
				...
				float staticSwitch421 = v.color.a;
			#else
				float staticSwitch421 = v.texcoord.xy.y;
			#endif
...
Node;AmplifyShaderEditor.StaticSwitch;421;-2408.807,904.8246;Inherit;False;Property;_Usevertexcolorforwind;Use vertex color for wind;6;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
WireConnection;421;0;422;4
ASEEND*/
//CHKSM=F2EE9E4A70B44B0A881F285F8BA806F112F5A7FF